#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from transformers/models/qwen3/modeling_qwen3.py.
...
# Try to import Qwen3Config, fallback to Qwen2Config if not available
try:
    from transformers.models.qwen3.configuration_qwen3 import Qwen3Config
except ImportError:
    try:
        # Try to import from transformers registry
...
class Qwen3DecoderLayer(nn.Module):
    def __init__(self, config: Qwen3Config, layer_idx: int):
        ...
        self.post_attention_layernorm = Qwen3RMSNorm(config.hidden_size, eps=getattr(config, "rms_norm_eps", 1e-6))
...
class Qwen3RotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen3Config, device=None):
        ...
        self.original_max_seq_len = getattr(config, "max_position_embeddings", 32768)
